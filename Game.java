...
public class Game {
    ...
    private static void getViews(){
        canvas = (RelativeLayout)Fishes.newGame.findViewById(R.id.canvas);
        start = (Button)Fishes.newGame.findViewById(R.id.start);
        pause = (Button)Fishes.newGame.findViewById(R.id.pause);
        restart = (Button)Fishes.newGame.findViewById(R.id.restart);
    }
