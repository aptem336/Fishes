...
public class Game {
    ...
    private static void addMyFish() {
        ...
        myFish.size = Float.parseFloat(Data.score);
    }
    ...
    private static class Engine extends AsyncTask<Void, Integer, Void> {
        ...
        private void just_do_it() {
            ...
            if (myFish != null) {
                TextView scoreTextView = Fishes.newGame.findViewById(R.id.score);
                Data.score = myFish.size + "";
                scoreTextView.setText(Data.score);
            }
        }
    }
}